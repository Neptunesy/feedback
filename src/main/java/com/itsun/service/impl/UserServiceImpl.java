...
import com.itsun.dao.UserVoMapper;
import com.itsun.domain.UserVo;
import com.itsun.domain.UserVoExample;
...
//            用户密码加密
            String encodePwd = FeedBackUtils.MD5encode(userVo.getUsername() + userVo.getPassword());
    ...
    public UserVo login(String username, String password) {
        ...
        String pwd = FeedBackUtils.MD5encode(username + password);
