...
public class FeedBackUtils {
    private static final Logger LOGGER = LoggerFactory.getLogger(FeedBackUtils.class);
    /**
     * 一个月
     */
    ...
    private static String location = FeedBackUtils.class.getClassLoader().getResource("").getPath();
...
//            默认是classPath路径
    ...
    public static DataSource getNewDataSource() {
        if (newDataSource == null) synchronized (FeedBackUtils.class) {
            if (newDataSource == null) {
                Properties properties = FeedBackUtils.getPropFromFile("application-default.properties");
